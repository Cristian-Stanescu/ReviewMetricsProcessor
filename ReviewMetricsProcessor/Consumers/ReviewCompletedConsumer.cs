...
public class ReviewCompletedConsumer(ReviewMetricsDbContext dbContext, ILogger<ReviewCompletedConsumer> logger) : IConsumer<ReviewCompleted>
{
    public async Task Consume(ConsumeContext<ReviewCompleted> context)
    {
